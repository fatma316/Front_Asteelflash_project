...
@Component({
  selector: 'app-dashboard-metho',
  templateUrl: './dashboard-metho.component.html',
  styleUrls: ['./dashboard-metho.component.css']
})
export class DashboardMethoComponent implements OnInit {
