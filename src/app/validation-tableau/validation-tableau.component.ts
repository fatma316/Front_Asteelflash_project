...
@Component({
  selector: 'app-validation-tableau',
  templateUrl: './validation-tableau.component.html',
  styleUrls: ['./validation-tableau.component.css']
})
export class ValidationTableauComponent implements OnInit {
