...
@Component({
  selector: 'app-dashboard-validator',
  templateUrl: './dashboard-validator.component.html',
  styleUrls: ['./dashboard-validator.component.css']
})
export class DashboardValidatorComponent implements OnInit {
