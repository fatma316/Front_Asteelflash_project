...
@Component({
  selector: 'app-consultervalidationoperator',
  templateUrl: './consultervalidationoperator.component.html',
  styleUrls: ['./consultervalidationoperator.component.css']
})
export class ConsultervalidationoperatorComponent implements OnInit {
